...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "healthy", "degraded", "down", "unknown", name="cloudflaretunnelstatus", native_enum=False
            ),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["environment_id"],
            ["environments.id"],
            name=op.f("cloudflare_tunnels_environment_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tunnel_id"],
            ["cloudflare_tunnels.id"],
            name=op.f("tunnel_public_hostnames_tunnel_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
            name=op.f("tunnel_public_hostnames_created_by_fkey"),
            ondelete="SET NULL",
        ),
