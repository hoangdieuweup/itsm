"""Create a DNS record on a zone in a Cloudflare account — account-level API proxy.

Called by POST /cloudflare-accounts/{account_id}/zones/{zone_id}/dns-records.
"""
...
class CreateAccountDnsRecord(AbstractUseCase):
    ...
    async def execute(
        ...
        *,
        ...
        return await self._client.create_dns_record(
            zone_id=zone_id,
            api_token=plaintext,
