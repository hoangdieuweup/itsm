...
This project is indexed by GitNexus as **itsm** (7005 symbols, 18977 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
