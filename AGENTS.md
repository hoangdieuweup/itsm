...
This project is indexed by GitNexus as **itsm** (1204 symbols, 2004 relationships, 32 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
