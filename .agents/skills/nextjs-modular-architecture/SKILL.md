...
| Constants & string literals | Never hardcode string literals for auth status, roles, resources, actions, permissions — use `shared/constants/` | references/rbac-ui.md |
