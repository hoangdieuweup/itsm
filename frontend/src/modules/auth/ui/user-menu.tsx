 ...
 * logout action. Logging out asks for confirmation first, and lets the user
 * end their WeUp DX session too. Only rendered inside `AuthGuard` (dashboard
 * layout), so the session query is already prefetched/hydrated — this read
